# -*- coding: utf8 -*-
"""
Tests related to functionality of grafana_testing.grafanaapi module
"""

import pytest
from grafanatesting.grafanaapi import grafanaapi
...
def test_get_targets(grafana_target, expected_targets):
    ...
    recursively.
    """
    grafana = grafanaapi.GrafanaApi("test")

    panel = {
        "targets": [
            {"target": grafana_target}],
        "title": "Test panel"}
    targets = grafana.get_panel_chart_targets(panel, "host-name", "cluster-id")
